...
一个面向中国高校保研/推免申请的资讯追踪 skill。它会用温柔陪伴式语气，先收集用户基础信息和个人背景，再检索官方来源，整理可筛选表格，维护可复用申请材料库，并基于数据给出“冲、稳、保”三档建议。

它不是单纯的择校建议模板，而是一个“官方信息检索 + 院校画像 + 材料复用 + 个人申请追踪 + 定时更新提醒”的工作流。
